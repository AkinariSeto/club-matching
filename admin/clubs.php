                    ...
                    <div class="container">
                        <div>
                            <table class="table table-striped table-borderless table-hover my-5">
                                ...
                                <a href="add_clubs.php"><button class="btn btn-success btn-block" type="submit" name="">Add
                                        Club</button></a>
                                <thead>
                                    <th>Club ID</th>
                                    <th>Club Name</th>
                                ...
                                <tbody>
                                    <?php
                                $get_clubs = $clubs->selectAll();

                                if($get_clubs) {
                                    foreach($get_clubs as $key => $row) {
                                        $id = $row['club_id'];
                                        echo "<tr>";
                                        ...
                                        ?>
                                    <a href='club_action.php?action=delete&club_id=<?php echo $id; ?>'
