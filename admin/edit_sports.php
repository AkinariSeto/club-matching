            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="card mt-5">
                            <div class="card-body">
                                <form class="my-5" action="sport_action.php?action=update" method="post">
                                    <input type="hidden" name="sport_id" value="<?php echo $_GET['sport_id']; ?>">
