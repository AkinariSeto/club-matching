                        ...
                        <div>
                            <table class="table table-striped table-borderless table-hover my-5">
                                <div class="card-header">
                                    <h4>Display Skill Level</h4>
                                </div>
                                <a href="add_skill_level.php"><button class="btn btn-success btn-block" type="submit" name="">Add
                                        Skill Level</button></a>
                                <thead>
                                    <th>Skill Level ID</th>
                                    <th>Slill Level Name</th>
                                    <th>Action</th>
                                </thead>
                                <tbody>
                                    <?php
